...
table_out <- pct_flow_instant_tbl_data %>%
  ...
  dplyr::select(`Station Name`, `ID`, `Record Length`, `Basin Area (km2)`,
                `Last 24 hour Q (m3/s)`, `Percentile - Last 24 Hour Q (m3/s)`, 
                 `Latest 7 Day Q (m3/s)`, `Percentile - Q7`, `Historic Min 7 Day Q (m3/s)`, 
                `Historic Mean Q7 for today`, `Percent of Daily Mean Q7 (%)`,
                `Historic Median Q7 for today`, `Percent of Daily Median Q7 (%)`,
